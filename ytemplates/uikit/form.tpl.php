...
if ('' != $this->objparams['form_action']) {
	...
	$formClass = preg_replace('/\brex-yform\b/', '', $this->objparams['form_class']);

	echo '<form action="' . $action_url . '" method="' . $this->objparams['form_method'] . '" id="' . $this->objparams['form_name'] . '" class="' . $formClass . '" enctype="multipart/form-data">';
}
...
foreach ($this->objparams['form_output'] as $field) {
	echo $field;
}
